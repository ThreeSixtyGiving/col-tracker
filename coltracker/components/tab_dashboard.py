                ...
                children=[
                    ...
                    html.Div(
                        ...
                        children=[
                            dcc.Markdown(
                                """
        Grants are included if the use the terms "cost of living" somewhere
        in the grant description, title, or grant programme. This is based on
        [guidance for grantmakers issued by 360Giving](https://www.threesixtygiving.org/2022/09/28/col/).
