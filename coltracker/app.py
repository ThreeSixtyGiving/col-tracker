...
server = app.server
if os.environ.get("FLASK_ENV", "production") == "development" or app.server.debug:
...
PROMETHEUS_GRANTS_COUNT_GAUGE = Gauge(
    "col_tracker_grants_count", "Count of grants in the Cost of Living Tracker"
)

PROMETHEUS_RECIPIENTS_COUNT_GAUGE = Gauge(
    "col_tracker_recipients_count", "Count of recipients in the Cost of Living Tracker"
)

PROMETHEUS_FUNDERS_COUNT_GAUGE = Gauge(
    "col_tracker_funders_count", "Count of funders in the Cost of Living Tracker"
)

PROMETHEUS_AMOUNT_AWARDED_GBP_GAUGE = Gauge(
    "col_tracker_amount_awarded_gbp",
    "Amount Awarded in the Cost of Living Tracker in GBP",
)
...
app.title = "Cost of Living Grants Tracker"
app.layout = layout()
